...
from node_example.msg import TopologicalMap
from node_example.msg import TopologicalAction
from node_example.msg import TopologicalNode
from node_example.msg import TopologicalEdge
...
pub_pose=rospy.Publisher("/irat_red/ExperienceMap/RobotPose",PoseStamped,queue_size=10)
pub_em=rospy.Publisher("/irat_red/ExperienceMap/Map",TopologicalMap,queue_size=10)
em_marker=Marker()
pub_em_markers=rospy.Publisher('/irat_red/ExperienceMap/MapMarker',Marker)
